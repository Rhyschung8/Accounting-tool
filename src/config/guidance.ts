...
export const GOOD_TO_KNOW: GuidanceTopic[] = [
  {
    ...
    bodyKo:
      ...
      '등록하지 않으면 벌금이 부과될 수 있으므로 수입이 발생한 세금연도가 끝난 후 빠르게 등록하는 것이 중요합니다. ' +
  ...
  },
  {
    ...
    bodyKo:
      '레슨과 직접 관련된 비용은 소득에서 공제할 수 있습니다: 전문 회비·보험, 교통비, 악기·교재, 홍보비, 재택근무비, 교육·연수비가 포함됩니다. ' +
      ...
      '현금주의(Cash Basis)로 신고한다면, 피아노 같은 업무용 기기를 구입한 해에 바로 전액 비용으로 공제할 수 있습니다.',
    bodyEn:
  ...
  },
  {
    ...
    bodyKo:
      '영국 세금연도는 매년 4월 5일에 끝납니다. 예를 들어 2025/26 세금연도는 2026년 4월 5일에 마감됩니다. ' +
      '자영업자로 새로 등록해야 한다면, 해당 세금연도가 끝난 다음 해 10월 5일까지 HMRC에 알려야 합니다. ' +
      '온라인으로 세금 신고서를 제출하고 세금을 납부하는 마감일은 모두 이듬해 1월 31일입니다. ' +
      '이 날짜들을 놓치면 자동으로 벌금이 부과되므로 미리 일정표에 표시해 두세요.',
    bodyEn:
  ...
  },
  {
    ...
    bodyKo:
      '세금 서류에는 낯선 단어들이 많이 나옵니다. 주요 용어는 다음 용어집을 참고하세요. ' +
